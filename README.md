...
2. 드롭다운 목록에서 제사하고 싶은 "워크스페이스(폴더)"를 선택합니다.
3. 입력창에 자연어로 위대한 미션을 하명합니다:
...
4. **Send(보내기)!** 
   - 전송 후 로딩바가 돕니다. 당신의 Mac 백그라운드에서는 Gemini 기반 자율 에이전트가 코드를 탐색하고 수정하며 터미널과 고군분투 중입니다.
   - 몇십 초 뒤, 폰에 완성된 결과 요약 보고서와 소스코드 내역이 딱! 출력됩니다!
